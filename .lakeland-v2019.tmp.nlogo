...
;; TODO fix gold moving when updating gold_resource
;; TODO fix fish coming onto land (switch off wrapping?)
...
globals [
  ...
  NumSocCom
  NumIm
  PrevFishPop                ;; variables to record the previous fish population and gold resource
  PrevGoldResource           ;; required for updating UI with new stock of fish and gold
]
...
to setup
  ...
  create-gold Gold_Resource [
    set shape "star"
    set color yellow
    setxy random-xcor random 6 - 16            ;; distribute gold randomly at the bottom of the land
    set size 0.75
  ]
...
to go
  ...
  set PrevFishPop Fish_pop
  set PrevGoldResource Gold_Resource
...
to moveconsumats
  ...
  ask consumats [
    ifelse Miningtime < Fishingtime                ;; if consumat wants to spend more time fishing
    [ setxy random-xcor random 23 - 7
      set shape "personboat" ]            ;; send to sea with a boat
    [ setxy random-xcor random 6 - 16
      set shape "person" ]            ;; otherwise send to gold mine
  ]
...
to changefishgold
  ...
  if PrevFishPop < Fish_pop
  [
    create-fish Fish_pop - PrevFishPop [
      setxy random-xcor random 23 - 7            ;; distribute fish randomly in water
      set color orange - 1                            ;; green in colour
      set shape "fish"                           ;; and are shaped like fish
      set size 0.75
  ...
  if PrevGoldResource < Gold_Resource
  [
    create-gold Gold_Resource - PrevGoldResource [
      set shape "star"
      set color yellow
      setxy random-xcor random 6 - 16            ;; distribute gold randomly at the bottom of the land
      set size 0.75
...
"" ""
PENS
"Fishing" 1.0 0 -16777216 true "" "plot mean [Fishingtime] of consumats"
"Mining" 1.0 0 -13345367 true "" "plot mean [Miningtime] of consumats"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [Locpop_Finance] of consumats"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [LNS] of consumats"
...
Polygon -7500403 true true 195 90 240 150 225 180 165 105
Polygon -7500403 true true 105 90 60 150 75 180 135 105
Polygon -2674135 true false 0 150 60 195 240 195 300 150 240 300 60 300
